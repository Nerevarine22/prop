...
export const PRIMARY_RESEARCH_BY_SLUG: Record<string, FirmPrimaryResearch> = {
  ...
  hypernova: research('hypernova', [
    ...
    { field: 'payoutPolicy', value: 'The live stats dashboard snapshot on September 9, 2026 reports $754,589 in lifetime payouts across 134 recipients, a $1,013 average payout, an $8,000 largest payout and 5.9-second average settlement across 745 payouts. Recent rows expose individual Arbitrum transaction hashes.', status: 'conflict', sourceUrl: 'https://hypernova.xyz/stats', notes: 'These are dynamic company-published figures backed by linked on-chain transactions. The 5.9-second observed settlement figure conflicts with the rulebook claim of an average below 0.02 seconds.' },
    { field: 'payoutPolicy', value: 'The same September 9 stats snapshot reports $621,665 in USDC across the published cold reserve and operational vault, $3.31M of funded-trader AUM, 62 funded traders, 628 paid traders, 211 funded accounts and 134 payout recipients.', status: 'reported', sourceUrl: 'https://hypernova.xyz/stats', notes: 'Balances and funnel metrics are time-sensitive snapshots. Reserve addresses are published at https://hypernova.xyz/docs/smart-contract#active-addresses.' },
    { field: 'payoutPolicy', value: 'Rulebook states average payout processing under 0.02 seconds.', status: 'conflict', sourceUrl: 'https://hypernova.xyz/rulebook', notes: 'The September 9, 2026 live stats dashboard reports 5.9 seconds across 745 payouts.' },
  ...
  northbook: research('northbook', [
    nd('officialWebsite', 'https://northbook.xyz', ''),
    nd('rulebook', 'https://northbook.xyz', ''),
    nd('faq', 'https://northbook.xyz', ''),
    nd('pricingCheckout', 'https://northbook.xyz', ''),
    nd('terms', 'https://northbook.xyz', ''),
    nd('payoutPolicy', 'https://northbook.xyz', ''),
    nd('tokenRewards', 'https://northbook.xyz', ''),
  ]),
  xato: research('xato', [
    nd('officialWebsite', 'https://xato.com', ''),
    nd('rulebook', 'https://xato.com', ''),
    nd('faq', 'https://xato.com', ''),
    nd('pricingCheckout', 'https://xato.com', ''),
    nd('terms', 'https://xato.com', ''),
    nd('payoutPolicy', 'https://xato.com', ''),
    nd('tokenRewards', 'https://xato.com', ''),
  ]),
  vest: research('vest', [
    nd('officialWebsite', 'https://trade.vestmarkets.com', ''),
    nd('rulebook', 'https://trade.vestmarkets.com', ''),
    nd('faq', 'https://trade.vestmarkets.com', ''),
    nd('pricingCheckout', 'https://trade.vestmarkets.com', ''),
    nd('terms', 'https://trade.vestmarkets.com', ''),
    nd('payoutPolicy', 'https://trade.vestmarkets.com', ''),
    nd('tokenRewards', 'https://trade.vestmarkets.com', ''),
  ]),
  ferm: research('ferm', [
    nd('officialWebsite', 'https://tryferm.com', ''),
    nd('rulebook', 'https://tryferm.com', ''),
    nd('faq', 'https://tryferm.com', ''),
    nd('pricingCheckout', 'https://tryferm.com', ''),
    nd('terms', 'https://tryferm.com', ''),
    nd('payoutPolicy', 'https://tryferm.com', ''),
    nd('tokenRewards', 'https://tryferm.com', ''),
  ]),
  levli: research('levli', [
    nd('officialWebsite', 'https://levli.io', ''),
    nd('rulebook', 'https://levli.io', ''),
    nd('faq', 'https://levli.io', ''),
    nd('pricingCheckout', 'https://levli.io', ''),
    nd('terms', 'https://levli.io', ''),
    nd('payoutPolicy', 'https://levli.io', ''),
    nd('tokenRewards', 'https://levli.io', ''),
  ]),
};
