...
const INPUTS: DiscrepancyInput[] = [
  ...
  { slug: 'hypernova', id: 'payout-speed', label: 'Average payout processing speed', canonicalId: 'hypernova-payoutPolicy-8', alternateIds: ['hypernova-payoutPolicy-10'], kind: 'official-source-mismatch', resolutionBasis: 'specific-policy-preferred', notes: 'The dated live-stats measurement is used for display; the rulebook claim remains conflicting official evidence.' },
