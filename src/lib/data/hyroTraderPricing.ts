...
export function withHyroTraderPricing(profile: FirmNormalizedProfileV2): FirmNormalizedProfileV2 {
  ...
  return withHyroTraderRules({
    ...
    editorialCopy: {
      ...
      'programs.note': 'Company-reported prices checked 20 Sep 2026. Swing is optional; percentage increases are calculated as add-on ÷ base fee, rounded to one decimal. Prices may change; confirm the final quote before purchase.',
    ...
    comparison: { ...profile.comparison, entryCost: { status: 'varies', min: 59, max: 1299, unit: 'USD', notes: 'Base evaluation fees; optional Swing upgrade costs extra. Checked 20 Sep 2026.' } },
